...
// Gated on the "dyndb-local-integration" feature — requires Docker for DynamoDB Local.
//
...
#![cfg(feature = "dyndb-local-integration")]
...
// Shared DynamoDB Local container lifecycle for dyndb-local-integration tests.
